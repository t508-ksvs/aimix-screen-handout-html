...
- [x] 階段二：將 `input_example/` 內教材（英文句作）比對核對、修復解答錯誤，並發佈至 GitHub Pages
- [ ] 階段三：依據 `self-made-ebook` 規範持續擴充文法講義其餘章節（P19 之後）
